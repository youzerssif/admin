...
class Produit(models.Model):
    ...
    taille = ArrayField(models.PositiveIntegerField(), null=True,size=8,)
    familly = JSONField(null=True)
    prix = IntegerRangeField(null=True)
    periode_promo = DateTimeRangeField(null=True)
